...
An external Gmail test with subject `Hailink Labs email verification 2026-09-14` was sent to the company mailbox. Company receipt, reply delivery and authentication headers remain NOT VERIFIED pending that reply. No email DNS was changed.
